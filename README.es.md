...
Es de código abierto y cualquier contribución es bienvenida.
...
Este proyecto es de código abierto y las contribuciones son bienvenidas — reportes
de bugs, ideas de funcionalidades o pull requests. Siéntete libre de abrir un issue
o PR.
